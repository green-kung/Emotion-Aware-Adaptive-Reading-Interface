...
export default function QuestionView({ passage, trialIdx, totalTrials, onNext, onFinish, onAnswer }) {
  ...
  return (
    <div>
      ...
      <div className="q-notice">
        <span className="q-notice-icon">ℹ</span>
        Answer from memory. The passage is no longer available for reference.
      </div>
